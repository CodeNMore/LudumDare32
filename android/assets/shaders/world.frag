...
void main(){
	...
	for(int i = 0;i < amountLights;i++){
		...
		if(i == 0){
			...
			//loopedColor = mix(loopedColor, mixedColor * vec4(amountLights, amountLights, amountLights, 1), 0.5);
			loopedColor += mixedColor;
		}
	}
